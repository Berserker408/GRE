% This Demo shows how to use functions lare/lpre to select the important 
...
% we weight samples with the Kaplan-Meier weight. The best lambda is choosen
